            ...
            <div className="flex items-center justify-between p-6 border-b border-neutral-200">
              <div>
                ...
                <p className="text-neutral-600">
                  Share evidence or testimony to document the human cost of war
                </p>
              </div>
              <button
                onClick={handleClose}
                  ...
                  >
                    <div className="flex flex-col items-center space-y-4">
                      ...
                      <p className="text-sm text-neutral-500">
                        Supports: JPG, PNG, WebP, MP4 (Max 10MB each)
                      </p>
                    </div>
                  </div>
                ) : (
                ...
                <div className="w-full lg:w-96 border-t lg:border-t-0 lg:border-l border-neutral-200 p-6 overflow-y-auto">
                  ...
                  >
                    <div>
                      ...
                      <input
                        {...register("title", {
                          required: "Title/Subject is required",
                        })}
                        type="text"
                        className="input"
                        placeholder="Descriptive title of the evidence or testimony"
                      />
                      {errors.title && (
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Provide details about what is shown, when and where it occurred, or share your testimony..."
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="children, medical, infrastructure, testimony"
                        />
                      </div>
                      ...
                      <div className="space-y-3">
                        <label className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-neutral-600">
                              Photographic or video evidence that you can verify
                              as authentic
                            </div>
                          </div>
                        </label>
                        ...
                        <label className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-neutral-600">
                              First-hand account or witness testimony of events
                            </div>
                          </div>
                        </label>
                        ...
                        <label className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-neutral-600">
                              Documentation from official sources, NGOs, or
                              medical facilities
                            </div>
                          </div>
                        </label>
                        ...
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-green-700 mt-1">
                              Your submission will be immediately visible to the
                              public after a brief verification check. You'll
                              receive an email confirmation when published.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-blue-700 mt-1">
                              Your submission will be saved privately. You can
                              publish it later when you're ready or if you need
                              to add more information or verification.
                            </p>
                          </div>
                        </div>
                      </div>
