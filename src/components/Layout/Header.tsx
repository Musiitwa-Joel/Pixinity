        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-2 group">
            <div className="relative">
              <Scale className="h-8 w-8 text-amber-600 group-hover:text-amber-700 transition-colors" />
              <div className="absolute -inset-1 bg-amber-600/20 rounded-full opacity-0 group-hover:opacity-100 transition-opacity blur" />
            </div>
            ...
            <form onSubmit={handleSearch} className="w-full relative">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search evidence and testimonies"
